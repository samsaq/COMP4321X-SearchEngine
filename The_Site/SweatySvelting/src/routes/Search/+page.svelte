...
<main>
  ...
  <div id="search-content-container">
    ...
    >
      ...
      <h2 class="search-step {heroAnimating ? 'animate-search-step' : ''}">
        Let's
      </h2>
      <h2 class="search-step {heroAnimating ? 'animate-search-step' : ''}">
        Search for
  ...
  <div
    class="resultsHolder flex flex-col justify-center items-center backdrop-blur-sm min-w-fit {heroAnimating
      ? 'broughtUp'
      : ''}"
  >
    {#if resultsJson}
