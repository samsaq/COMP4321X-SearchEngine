<script lang="ts">
  ...
  import { searchHistory, selectedOldQuery } from "../historyStore";
...
<div class="flex flex-col justify-start items-center drawerContainer">
  <span class="text-xl py-4 underline-offset-4 underline search-history-hero"
    >Search History</span
  >
  <nav class="list-nav">
    <ul>
